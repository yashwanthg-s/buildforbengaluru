-- Migration: Add resolution images table and columns
-- This script adds support for officers to upload before/after images when resolving complaints

USE complaint_system;

-- Step 1: Add columns to complaints table if they don't exist
